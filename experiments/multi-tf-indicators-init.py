...
import numpy as np
import pandas as pd
# , nan, nan, 5.07, nan, 5.049, nan, 5.073999999999999, nan, 5.1290000000000004, nan, 5.125, nan, 5.111, nan, 5.053, nan, 5.046, nan, 5.011, nan, 5.045, nan, 5.058, nan, 5.078, nan, 5.036, nan, 4.999, nan, 4.964, nan, 4.753, nan, 4.628, nan, 4.776, nan, 4.822, nan, 4.86, nan, 4.865, nan, 4.763, nan, 4.781, nan, 4.857, nan, 4.766, nan, 4.796, nan, 4.885, nan, 4.911, nan, 4.898, nan, 4.875, nan, 4.863, nan, 4.907, nan, 4.871, nan, 4.861, nan, 4.883, nan, 4.927, nan, 4.943, nan, 4.96, nan, 4.973, nan, 4.998, nan, 4.976, nan, 4.972, nan, 4.962, nan, 5.001, nan, 4.958, nan, 4.954, nan, 4.968, nan, 4.948, nan, 4.94, nan, 4.916, nan, 4.915, nan, 4.921, nan, 4.93, nan, 4.953, nan, 4.953, nan, 4.975, nan, 4.998, nan, 4.981, nan, 4.975, nan, 4.972, nan, 4.991, nan, 4.968, nan, 4.951, nan, 4.921, nan, 4.882, nan, 4.905, nan, 4.958, nan, 4.919, nan, 4.881, nan, 4.909, nan, 4.907, nan, 4.888, nan, 4.908, nan, 4.959, nan, 4.901, nan, 4.949, nan, 4.965, nan, 4.961, nan, 4.951, nan, 4.99, nan, 5.016, nan, 5.018, nan, 5.002, n
# 5.07, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.049, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.073999999999999, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.1290000000000004, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.125, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.111, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.053, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.046, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.011, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.045, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.058, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.078, nan, nan, nan, nan, nan, nan, nan, nan, nan, 5.036, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.999, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.964, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.753, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.628, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.776, nan, nan, nan, nan, nan, nan, nan, nan, nan, 4.822, na
...
class ST(StrategyBase):
    ...
    def __init__(self):
        ...
        # self.datas_5m = self.datas[0:1]
        # self.datas_5m = self.datas[1:]
        self.datas_5m = self.datas
        # self.local_datas = {}
        # for d in self.datas:
        #     ticker = d._name
        #     tf = ticker[0:2]
        #     self.local_datas[f'{tf}'] = d
        #     self.local_datas[f'{tf}']._name = ticker
        ...
        for d in self.datas:
            ...
            self.pos[ticker] = {}
            tf = d._name[0:2]
            self.inds[ticker][f"volsma_slow_{tf}"] = bt.indicators.SMA(d.volume, period=20, plot=True, subplot=True)
            self.inds[ticker][f"volsma_fast_{tf}"] = bt.indicators.SMA(d.volume, period=100, plot=True, subplot=True, plotmaster=self.inds[ticker][f"volsma_slow_{tf}"])
            self.inds[ticker][f"volsma_fast_{tf}"].plotlines.sma.color = 'orange'
            self.inds[ticker][f"rsi_{tf}"] = bt.indicators.RSI(d, plot=True, subplot=True)
            self.inds[ticker][f"adx_{tf}"] = bt.indicators.ADX(d, plot=True, subplot=True)
            self.inds[ticker][f"sma_adx_20"] = bt.ind.HMA(self.inds[ticker][f"adx_{tf}"], period=20, plot=True, subplot=True, plotmaster=self.inds[ticker][f"adx_{tf}"])
            self.inds[ticker][f"sma_adx_20"].plotlines.hma.color = 'orange'
            self.inds[ticker][f"atr_{tf}"] = bt.indicators.ATR(d, plot=True, subplot=True)
            self.inds[ticker][f"volatility_{tf}"] = 1 / ((self.inds[ticker][f"atr_{tf}"] / d.high) * 100)
            self.inds[ticker][f"hh_{tf}"] = bt.indicators.Highest(d.high, period=50, plot=False, subplot=False)
            self.inds[ticker][f"hh_fast_{tf}"] = bt.indicators.Highest(d.high, period=10, plot=False, subplot=False)
            self.inds[ticker][f"hh_fastest_{tf}"] = bt.indicators.Highest(d.high, period=2, plot=False, subplot=False)
            self.inds[ticker][f"ll_{tf}"] = bt.indicators.Lowest(d.low, period=50, plot=False, subplot=False)
            self.inds[ticker][f"ll_fast_{tf}"] = bt.indicators.Lowest(d.low, period=10, plot=False, subplot=False)
            self.inds[ticker][f"ll_fastest_{tf}"] = bt.indicators.Lowest(d.low, period=2, plot=False, subplot=False)
            self.inds[ticker][f"sma5_{tf}"] = bt.indicators.EMA(d.close, period=5, plot=False, subplot=False)
            self.inds[ticker][f"sma20_{tf}"] = bt.indicators.EMA(d.close, period=20, plot=True, subplot=False)
            self.inds[ticker][f"sma50_{tf}"] = bt.indicators.EMA(d.close, period=50, plot=True, subplot=False)
            # self.inds[ticker][f"sma60_{tf}"] = bt.indicators.EMA(d.close, period=60, plot=True, subplot=False)
            self.inds[ticker][f"sma100_{tf}"] = bt.indicators.EMA(d.close, period=100, plot=True, subplot=False)
            self.inds[ticker][f"sma240_{tf}"] = bt.indicators.SMA(d.close, period=240, plot=True, subplot=False)
            # self.inds[ticker][f"roc"] = bt.indicators.ROC(d.close, period=10, plot=False, subplot=False)
            self.inds[ticker][f"pct_change_30"] = bt.indicators.PctChange(d.close, plot=False, subplot=False)
            self.inds[ticker][f"pct_change_240"] = bt.indicators.PctChange(d.close, period=240, plot=False, subplot=False)
            # self.inds[ticker][f"roc_std"] = bt.indicators.StdDev(self.inds[ticker][f"roc"], period=10, plot=False, subplot=False)
            # self.inds[ticker][f"roc_std_sma10"] = bt.indicators.EMA(self.inds[ticker][f"roc_std"], period=10, plot=False, subplot=False)
            # self.inds[ticker][f"roc_std_sma20"] = bt.indicators.EMA(self.inds[ticker][f"roc_std"], period=20, plot=False, subplot=False)
            # self.inds[ticker][f"roc_std_sma20"].plotinfo.plotmaster = self.inds[ticker][f"roc_std_sma10"]
            # self.inds[ticker][f"roc_std_sma50"] = bt.indicators.EMA(self.inds[ticker][f"roc_std"], period=50, plot=False, subplot=False)
            # self.inds[ticker][f"roc_std_sma50"].plotinfo.plotmaster = self.inds[ticker][f"roc_std_sma10"]
            # self.inds[ticker][f"roc_std_sma200"] = bt.indicators.EMA(self.inds[ticker][f"roc_std"], period=200, plot=False, subplot=False)
            # self.inds[ticker][f"roc_std_sma200"].plotinfo.plotmaster = self.inds[ticker][f"roc_std_sma10"]

            # self.inds[ticker][f"st_5m"] = SuperTrend(d, plot=True)
        # for d in self.datas_1h:
        #     ticker = d._name
        #     ticker = ticker[3:]
        #     # self.inds[ticker][f"rsi_1h"] = bt.indicators.RSI(d, plot=True, subplot=True)
        #     # self.inds[ticker][f"adx_1h"] = bt.indicators.ADX(d, plot=True, subplot=True)
        #     # self.inds[ticker][f"hh_1h"] = bt.indicators.Highest(d.high, plot=True, subplot=True)
        #     # self.inds[ticker][f"ll_1h"] = bt.indicators.Lowest(d.low, plot=True, subplot=True)
        #     # self.inds[ticker][f"atr_1h"] = bt.indicators.ATR(d, plot=True, subplot=True)
        #     self.inds[ticker][f"sma5_1h"] = bt.indicators.EMA(d.close, period=5, plot=True, subplot=False)
        #     self.inds[ticker][f"sma20_1h"] = bt.indicators.EMA(d.close, period=20, plot=True, subplot=False)
        #     # self.inds[ticker][f"sma50_1h"] = bt.indicators.EMA(d.close, period=50, plot=True, subplot=False)
        #     # self.inds[ticker][f"st_1h"] = SuperTrend(d, plot=True)
    ...
    def next(self):
        if (self.check_for_live_data and self.status == "LIVE") or not self.check_for_live_data:
            ...
            # self.datas_5m.sort(reverse=True, key=lambda d: abs(self.inds[d._name[3:]]["pct_change"][0]) * (self.inds[d._name[3:]]["volsma_fast_5m"][0] - self.inds[d._name[3:]]["volsma_slow_5m"][0]))
            self.datas_5m.sort(reverse=True, key=lambda d: abs(self.inds[d._name[3:]]["pct_change_30"][0]))
            for d in self.datas_5m:
                # if '5m' in d._name:
                if len(d) > self._last_len:
                    self._last_len = len(d)
                    ticker = d._name
                    ticker = ticker[3:]
                    # print(f'{ticker} {self.inds[d._name[3:]]["pct_change_30"][0]} {self.inds[d._name[3:]]["pct_change_240"][0]}')
                    ...
                    if current_position < 0:
                        ...
                        self.pos[ticker]["profit_percentage"] = (self.pos[ticker]["profit"] / self.pos[ticker][
                            "price"]) * 100
                        # self.log(self.pos[ticker]["profit_percentage"])
                        # if self.pos[ticker]["profit_percentage"] > 95:
                        #     # self.log(f'{ticker} Long profit > 35%, updating stop win to 30%')
                    ...
                    if current_position == 0:
                        ...
                        # if abs(self.inds[ticker]["pct_change_30"][0]) > abs(self.inds[ticker]["pct_change_240"][0]):
                        if self.inds[ticker]["sma20_5m"][0] > self.inds[ticker]["sma50_5m"][0] > self.inds[ticker]["sma100_5m"][0] > self.inds[ticker]["sma240_5m"][0]:  # look for longs
                            if ticker in self.entry_stop_order:
                                self.cancel(self.entry_stop_order[ticker])
                            # self.entry_stop_order[ticker] = self.order_target_percent(d, target=((self.p.order_target_percent / 100) * self.inds[ticker]["volatility_5m"][0]))
                            self.log('buying')
                            self.entry_stop_order[ticker] = self.order_target_percent(d, target=((self.p.order_target_percent / 100) * 100*abs(self.inds[ticker]["volatility_5m"][0])))
                            ...
                            # self.close(exectype=bt.Order.Stop, price=self.pos[ticker]["sl_price"], parent=self.entry_stop_order[ticker])
                            ...
                            if ticker in self.entry_stop_order:
                                self.cancel(self.entry_stop_order[ticker])
                            self.entry_stop_order[ticker] = self.order_target_percent(d, target=-((self.p.order_target_percent / 100) * self.inds[ticker]["volatility_5m"][0]))
                            # self.entry_stop_order[ticker] = self.order_target_percent(d, target=-((self.p.order_target_percent / 100) * 100*abs(self.inds[ticker]["pct_change_30"][0])))
