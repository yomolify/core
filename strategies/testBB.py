...
# Create a cerebro entity
    ...
    # datapath = os.path.join(modpath, '../dataset/BTCUSDT-1h.csv')
    datapath = os.path.join(modpath, '../dataset/binance_nov_18_mar_19_btc.csv')

    # Create a Data Feed
    data = bt.feeds.GenericCSVData(
        dataname=datapath,
        # Do not pass values before this date
        fromdate=datetime.datetime(2018, 4, 4),
        # Do not pass values before this date
